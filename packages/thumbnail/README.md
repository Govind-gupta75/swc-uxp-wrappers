...
-   For detailed README regarding `@spectrum-web-components/thumbnail` [refer this link](https://www.npmjs.com/package/@spectrum-web-components/thumbnail/v/1.12.0)
