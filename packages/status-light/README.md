...
-   For detailed README regarding `@spectrum-web-components/status-light` [refer this link](https://www.npmjs.com/package/@spectrum-web-components/status-light/v/1.12.2)
