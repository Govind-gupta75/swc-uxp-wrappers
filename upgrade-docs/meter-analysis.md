# meter — 1.12.1 -> 1.12.2 (2026-08-27)

The `npm pack` diff between `@spectrum-web-components/meter@1.12.1` and `@1.12.2` showed only
...
pin bump only: `packages/meter/package.json`'s `@swc-uxp-internal/meter` dependency value was
updated from `npm:@spectrum-web-components/meter@1.12.1` to `@1.12.2`. The wrapper's own
